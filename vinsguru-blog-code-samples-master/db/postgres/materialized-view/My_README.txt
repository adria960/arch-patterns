...
1. docker-compose up
Note: If postgres is already in docker - take care of postgres and pgadmin config data - environment - username and password!
To be safe - rename containers - postgres and pgAdmin to postgres2 and pgadmin2.
Otherwise - leave it
